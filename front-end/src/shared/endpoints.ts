export class Endpoints {
  public static GET_BUDGET_ITEMS = '/budget/getBudgetItems'
  public static ADD_BUDGET_ITEM = '/budget/addBudgetItem'
  public static EDIT_BUDGET_ITEM = '/budget/editBudgetItem'
